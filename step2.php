...
<div class="my-3 p-3 bg-white rounded box-shadow">
	...
	<form id="formStep2" method="POST" class="mt-3">
		...
		<div class="input-group input-group-lg mb-3">
			...
			<input type="text" class="form-control" placeholder="Kontak Pasien" id="kontakPsn" name="kontakReg" value="{{telepon}}"  style="font-size:15px">
		</div>
		<div class="input-group input-group-lg mb-3">
		...
		<div class="input-group input-group-lg mb-3">
			...
			<input type="text" class="form-control" placeholder="No.Rujukan" id="noRujukanPsn" name="noRujukanPsn" style="font-size:15px" disabled="disabled">
			<div class="input-group-append">
				<button class="btn btn-outline-secondary" type="button" id="btnCariRujukan1">Cari Faskes 1</button>
				<button class="btn btn-outline-secondary" type="button" id="btnCariRujukan">Cari Faskes 2</button>
			</div>
		</div>
